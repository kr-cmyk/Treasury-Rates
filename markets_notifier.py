...
def main():
    ...
    body += f"STOCKS:\n"
    body += f"SPX: {stocks.get('SPX', 'N/A')} {pct_spx} {mtd_pct_spx} {ytd_pct_spx}\n"
    body += f"NDX: {stocks.get('NASDAQ', 'N/A')} {pct_nasdaq} {mtd_pct_nasdaq} {ytd_pct_nasdaq}\n"
    body += f"DOW: {stocks.get('DOW', 'N/A')} {pct_dow} {mtd_pct_dow} {ytd_pct_dow}\n\n"
    
    body += f"COMMODITIES:\n"
    body += f"WTI: ${wti_oil} {pct_wti} {mtd_pct_wti} {ytd_pct_wti}\n\n"
